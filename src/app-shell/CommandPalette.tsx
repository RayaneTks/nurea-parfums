...
export function CommandPalette({ open, onOpenChange }: CommandPaletteProps) {
  ...
  const actions: Action[] = [
    ...
    { id: "nav.settings", label: "Paramètres", icon: Settings, group: "Navigation", run: () => go("/admin/reglages") },
  ...
  return (
    <>
      ...
      <Command
        ...
        loop
        className="fixed left-1/2 top-[10vh] z-[90] w-[min(420px,92vw)] -translate-x-1/2 overflow-hidden rounded-[18px] bg-[var(--admin-surface)] shadow-[var(--admin-shadow-xl)]"
