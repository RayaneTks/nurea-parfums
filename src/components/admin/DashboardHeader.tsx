    ...
    <div className="space-y-5">
      ...
      <div className="flex border border-[var(--admin-border)] bg-[var(--admin-surface)] p-1">
        <button
          ...
          className={`relative flex min-h-[44px] flex-1 items-center justify-center gap-2 text-sm font-semibold transition-colors duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--admin-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--admin-ring-offset)] ${
            activeTab === "perfumes"
