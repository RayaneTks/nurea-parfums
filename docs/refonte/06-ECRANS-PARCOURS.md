...
- **Zones.**
  ...
  3. **Vitrine** : interrupteur « Visible sur la vitrine » (écriture immédiate, optimiste, rollback + toast portant la raison ; verrouillé avec la raison affichée : « Ajoute un visuel », « Rends d'abord la marque visible », « La marque est en gamme complète ») ; interrupteur « Mettre en avant · 1/2 » (seulement si visible).
