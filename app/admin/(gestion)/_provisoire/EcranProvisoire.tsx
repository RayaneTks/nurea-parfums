 ...
 *
 * Comme toute page du shell, elle ouvre la fiche document au-dessus d'elle quand l'URL porte `doc` (A-3).
 */
export function EcranProvisoire({ titre, jalon, docId }: { titre: string; jalon: string; docId?: string }) {
  return (
    <PageScaffold docId={docId} sheet={<DocumentSheetSlot docId={docId} />}>
