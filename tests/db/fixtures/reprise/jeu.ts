...
export const JEU: Ligne[] = [
  ...
  ["PerfumePricing", { perfumeId: 1, volumeMl: 100, defaultUnitPriceEur: "60.00", defaultUnitCostDzd: "5540.00", defaultExchangeRate: "277.0000", updatedAt: T("2026-03-05 14:00:00") }],
  ...
  ligneVente("vl-directe-1", "vente-directe-payee", 1, SAUVAGE, 100, 2, "60.00", "20.00", { unitCostDzd: "5540.00", exchangeRate: "277.00" }),
  ...
  ligneVente("vl-purgee-1", "vente-cmd-purgee", 1, SAUVAGE, 100, 1, "80.00", "25.00"),
  ...
  ligneCommande("ol-paire-livree-1", "cmd-paire-livree", 1, 100, 1, "90.00", "30.00", { unitCostDzd: "8310.00", exchangeRate: "277.00", deliveredQuantity: 1 }),
  ...
  ligneVente("vl-paire-livree-1", "vente-paire-livree", 1, SAUVAGE, 100, 1, "90.00", "0.00"),
  ...
  ligneCommande("ol-paire-annulee-1", "cmd-paire-annulee", 1, 30, 1, "35.00", "10.00"),
  ...
  ligneVente("vl-paire-annulee-1", "vente-paire-annulee", 1, SAUVAGE, 30, 1, "35.00", "10.00"),
  ...
  ligneCommande("ol-attente-1", "cmd-attente-acompte", 2, 100, 2, "55.00", "18.00", { unitCostDzd: "4986.00", exchangeRate: "277.00" }),
  ...
  ligneCommande("ol-partielle-1", "cmd-confirmee-partielle", 1, 100, 2, "70.00", "22.00", { deliveredQuantity: 1 }),
  ...
  ligneCommande("ol-annule-1", "cmd-paiement-annule", 2, 100, 1, "65.00", "20.00"),
  ...
  ligneCommande("ol-rembourse-1", "cmd-rembourse", 1, 100, 1, "100.00", "30.00", { deliveredQuantity: 1 }),
  ...
  ligneVente("vl-excedent-1", "vente-ventilation-excedent", 1, SAUVAGE, 100, 1, "75.00", "25.00"),
  ...
  ligneVente("vl-don-prix", "vente-don-volume-nul", 1, SAUVAGE, 30, 1, "5.00", "9.00", { isGift: true, note: "Offert pour l'anniversaire" }),
  ...
  ligneCommande("ol-doublon-1", "cmd-doublon", 2, 100, 1, "70.00", "21.00"),
  ...
  ligneVente("vl-negatif-1", "vente-reste-negatif", 2, KHAMRAH, 100, 1, "50.00", "16.00"),
  ...
  ligneVente("vl-excessif-1", "vente-reste-excessif", 1, SAUVAGE, 30, 1, "30.00", "9.00"),
  ...
  ligneCommande("ol-remontee-1", "cmd-paire-remontee", 1, 100, 1, "100.00", "32.00", { deliveredQuantity: 1 }),
  ...
  ligneVente("vl-remontee-1", "vente-paire-remontee", 1, SAUVAGE, 100, 1, "100.00", "32.00"),
  ...
  ligneVente("vl-avant-1", "vente-avant-tresorerie", 1, SAUVAGE, 100, 1, "85.00", "27.00"),

  // ─── Cas 25 : commande confirmée sans paiement ────────────────────────────────────────────────────
  ...
  // ─── Cas 26 : trop-perçu sur une commande livrée sans vente (D2) ─────────────────────────────────
  commande("cmd-trop-percu", "DELIVERED", T("2026-09-01 10:00:00"), { customerId: "cli-sofia", customerName: "Sofia Martin", deliveredAt: T("2026-09-02 12:00:00"), updatedAt: T("2026-09-02 12:00:00") }),
  ligneCommande("ol-trop-percu-1", "cmd-trop-percu", 1, 30, 1, "30.00", "9.00", { deliveredQuantity: 1 }),
...
const ORDRE = ["AdminUser", "AuditLog", "AppSetting", "Customer", "Batch", "Brand", "Perfume", "PerfumePricing", "Pocket", "Order", "OrderItem", "PaymentTransaction", "Sale", "SaleItem", "BatchExpense", "CashMovement"];
